...
{
    this->contador_muertos += enemigos_muertos;
    RenderTexto::get().render_texto(ren,15,45, "Enemigos muertos: " + std::to_string(contador_muertos),200,30, SDL_Color{0, 255, 255});
}
